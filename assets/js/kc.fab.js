        ...
        base.init = function(){
            ...
            main_fab_btn.click(function(e){
            	...
            	if ($(".kc_fab_overlay").length > 0){
                    ...
                    // $('body').append('<div class="kc_fab_overlay"><div class="container h-100"><div class="row justify-content-center align-self-center align-items-center h-100"><div class="jumbotron"><p class="text-center">JIKA ANDA MELIHAT PESAN INI TERLALU LAMA DAN TIDAK TERJADI APA-APA, <br> ITU BERARTI JARINGAN PADA PERANGKAT ANDA BERMASALAH ATAU TIDAK LANCAR.<br>SILAHKAN CEK KEMBALI KONEKSI ANDA, KEMUDIAN MUAT ULANG (REFRESH) HALAMAN INI KEMBALI.</p></div></div></div></div>');
                    $('body').append('<div class="kc_fab_overlay">'
                    +
                    // '<div style="height: 100vh; display: flex; justify-content: center; align-items: center;" class="d-flex justify-content-center"><div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div></div>'
                    '<div style="display: flex; justify-content: center; align-items: center;" class="d-flex justify-content-center"><button style="height: 100vh; width: 100%;  display: flex; justify-content: center; align-items: center;" class="form-control d-flex justify-content-center btn btn-primary text-center" type="button" disabled>'
                    +'<span class="spinner-border spinner-border-lg" role="status" aria-hidden="true"></span>&ensp;&ensp;<h4>LOADING...</h4></button></div>'
                    +'</div>');
                    // alert("Jika anda melihat pesan ini terlalu lama, dan tidak terjadi apa-apa,<br> itu berarti jaringan pada perangkat anda bermasalah atau tidak lancar.<br>Silahkan cek kembali koneksi anda, kemudian muat ulang (refresh) halaman ini.");
