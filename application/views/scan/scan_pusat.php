			...
			<div class="panel-body text-center">
				...
				<div class="alert alert-success" role="alert">
					...
					<p class="text-justify" style="text-align: justify; display:inline-block;">
						...
						Silahkan arahkan kamera yang terbuka ke marker atau qr code pada masing-masing siswa.
				...
				<form id='form_absen' action="<?= base_url('guru/absensi_pusat/cek') ?>" method="post">
					...
					<input type='text' id='qr' value='' name='qr' hidden>
					<button type="submit" class="btn btn-primary" hidden>Absen</button>
					<br><br>
				</form>
