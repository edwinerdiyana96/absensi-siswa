                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form action="<?= base_url('admin/editUserProfile/' . $user_edit['id'] . "/password") ?>" method="POST">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="<?= base_url('admin/editUserProfile/' . $user_edit['id'] . "/profile") ?>" method="POST">
