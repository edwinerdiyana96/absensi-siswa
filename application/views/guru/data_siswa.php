    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="d-none d-lg-block">
                <div class="row">
                    <div class="col-md-7">
                        <form action="<?= base_url('guru/data_siswa/filter') ?>" method="POST">
                            <div class="input-group mb-6">
                                ...
                                <button class="btn btn-primary btn-icon-split mb-2">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?= base_url('guru/data_siswa/filter') ?>" method="POST">
                        ...
                        <button class="form-control btn btn-primary mt-2" style="text-align: left;">
                            <span class="icon text-white-50">
                                <i class="fa fa-filter"></i>
                            </span> &ensp;&ensp;
                            <span class="text">Lihat Data</span>
                    ...
                    <button class="form-control btn btn-info" data-toggle="modal" data-target="#addNewUser" style="text-align: left;">
                        <span class="icon text-white-50">
                            <i class="fas fa-plus"></i>
                        </span> &ensp;&ensp;
                        <span class="text">Tambah Siswa</span>
...
<script>
    ...
    $(document).ready(function() {
        tabel = $('#table-siswa').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('guru/datatables_siswa/' . str_replace(" ", "-", $kelas_tampil)); ?>", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
            "aLengthMenu": [
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        ...
                        return '<a href="' + '<?= base_url(); ?>guru/update_pkl/' + data + '" class="btn btn-success" onclick="return ' + konfirmasi + '">RUBAH STATUS PKL</a>' +
                            ' ' +
                            '<a href="' + '<?= base_url(); ?>guru/editUserProfile/' + data + '" class="btn btn-primary">EDIT</a>' +
                            ' ' +
                            '<a href="' + '<?= base_url(); ?>guru/data_siswa/delete/' + data + '" class="btn btn-danger" onclick="return ' + konfirmasi + '">HAPUS</a>';
                    }
                },
            ],
        });
...
<div class="modal fade" id="addNewUser" tabindex="-1" aria-labelledby="addRoleModelLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('guru/data_siswa/add') ?>" method="POST">
