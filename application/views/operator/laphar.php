				...
				<table class="table table-striped table-bordered" id="table-kelas" style="width:100%;">
					<thead class="text-primary">
						<tr>
							...
							<th scope="col">Kode / Nomor WhatsApp</th>
					...
					<tbody>
					    <tr>
					        ...
					        echo $data_kelas['no_whatsapp_grade'];
					        ?></td>
					        <td>
					            <button class="btn btn-primary" data-toggle="modal" data-target="#kodeGroup1">Update Kode / No. WhatsApp</button>
					            <a href="<?= base_url('operator/laphar/kirim/X')?>">
					                <button class="btn btn-success">Kirim Laporan Harian</button>
					            </a>
					        </td>
					    </tr>
					    <tr>
					        ...
					        ?></td>
					        <td>
					            <button class="btn btn-primary" data-toggle="modal" data-target="#kodeGroup2">Update Kode / No. WhatsApp</button>
					            <a href="<?= base_url('operator/laphar/kirim/XI')?>">
					                <button class="btn btn-success">Kirim Laporan Harian</button>
					            </a>
					        </td>
					    </tr>
					    <tr>
					        ...
					        ?></td>
					        <td>
					            <button class="btn btn-primary" data-toggle="modal" data-target="#kodeGroup3">Update Kode / No. WhatsApp</button>
					            <a href="<?= base_url('operator/laphar/kirim/XII')?>">
					                <button class="btn btn-success">Kirim Laporan Harian</button>
					            </a>
					        </td>
					    </tr>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addRoleModelLabel">Update Kode / No. WhatsApp X</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form action="<?= base_url('operator/laphar/whatsapp') ?>" method="POST">
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="group_id" class="col-sm-12 control-label">Kode / No. WhatsApp</label>
						<input type="text" class="form-control" id="group_id" name="no_whatsapp" placeholder="Kode / No. WhatsApp">
					</div>
					<!--<div class="form-group">-->
...
<div class="modal fade" id="kodeGroup2" tabindex="-1" aria-labelledby="addRoleModelLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addRoleModelLabel">Update Kode / No. WhatsApp XI</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form action="<?= base_url('operator/laphar/whatsapp') ?>" method="POST">
				<div class="modal-body">
					<div class="form-group">
						<label for="grade" class="col-sm-12 control-label">Pilih Tingkat</label>
						<input type="text" class="form-control" id="grade" name="grade" value="XI" readonly placeholder="Kode / No. WhatsApp">
					</div>
					<div class="form-group">
						<label for="group_id" class="col-sm-12 control-label">Kode / No. WhatsApp </label>
						<input type="text" class="form-control" id="group_id" name="no_whatsapp" placeholder="Kode / No. WhatsApp">
...
<div class="modal fade" id="kodeGroup3" tabindex="-1" aria-labelledby="addRoleModelLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addRoleModelLabel">Update Kode / No. WhatsApp XII</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<form action="<?= base_url('operator/laphar/whatsapp') ?>" method="POST">
				<div class="modal-body">
					<div class="form-group">
						<label for="grade" class="col-sm-12 control-label">Pilih Tingkat</label>
						<input type="text" class="form-control" id="grade" name="grade" value="XII" readonly placeholder="Kode / No. WhatsApp">
					</div>
					<div class="form-group">
						<label for="group_id" class="col-sm-12 control-label">Kode / No. WhatsApp </label>
						<input type="text" class="form-control" id="group_id" name="no_whatsapp" placeholder="Kode / No. WhatsApp">
