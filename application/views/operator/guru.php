			...
			<div class="d-none d-lg-block">
				<div class="row">
					<div class="col-md-12">
						...
						<button class="btn btn-success btn-icon-split" onclick="window.location.href='<?= base_url('operator/export_guru') ?>'">
							<span class="icon text-white-50">
			...
			<div class="d-lg-none">
				<div class="row">
					<div class="col-md-12">
						...
						<br><br>
						<button class="btn btn-success form-control" onclick="window.location.href='<?= base_url('operator/export_guru') ?>'">
							<span class="icon text-white-50">
								<i class="fas fa-file-excel"></i>
							</span>
							<span class="text">Export To Excel</span>
...
<script>
	...
	$(document).ready(function() {
		tabel = $('#table-guru').DataTable({
			...
			"ajax": {
				"url": "<?= base_url('operator/data_guru'); ?>", // URL file untuk proses select datanya
				"type": "POST"
			},
			"deferRender": true,
			"aLengthMenu": [
			...
			"columns": [{
				...
				},
				{
					...
					"render": function(data, type, row, meta) {
						...
						return '<a href="' + '<?= base_url(); ?>operator/editGuruProfile/' + data + '" class="btn btn-primary">EDIT</a>' +
							' ' +
							'<a href="' + '<?= base_url(); ?>operator/deleteguru/' + data + '" class="btn btn-danger" onclick="return ' + konfirmasi + '">HAPUS</a>';
					}
				},
			],
		});
