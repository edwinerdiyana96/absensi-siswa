				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<form action="<?= base_url('operator/editGuruProfile/' . $user_edit['id'] . "/password") ?>" method="POST">
								<div class="form-group">
									<label for="new_password1">PASSWORD BARU</label>
									<input type="password" name="pass1" class="form-control" id="pass1" placeholder="Masukan Password Baru . . ." required>
									<div class="small text-danger"><?= form_error('new_password1'); ?></div>
								</div>

								<div class="form-group">
									<label for="formGroupExampleInput">KETIK ULANG PASSWORD BARU</label>
									<input type="password" name="pass2" class="form-control" id="pass2" placeholder="Ketik Ulang Password Baru . . ." required>
						...
						<script type="text/javascript">
							...
							function validatePassword() {
								...
								if (pass1 != pass2)
									document.getElementById("pass2").setCustomValidity("Passwords Tidak Sama, Harap Periksa Kembali!");
								else
			...
			<div class="card-body">
				<div class="row">
					<div class="col-lg-12">
						...
						<form action="<?= base_url('operator/editGuruProfile/' . $user_edit['id'] . "/profile") ?>" method="POST">
								...
								<div class="col-md-12">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="email" name="email" value="<?= $user_edit['email'] ?>" class="form-control" id="email">
										</div>
										<div class="form-group col-md-6">
											<label>Nama</label>
