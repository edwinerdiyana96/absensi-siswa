...
<ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion toggled" id="accordionSidebar">
    ...
    <div class="sidebar-brand d-flex align-items-center justify-content-center mt-4" href="#">
        <div class="row mt-4 ">
            <div class="col-md-12">
                <div>
                    <img class=" rounded-circle" width='75px' height="75px" src="<?= base_url($settings['logo']) ?>" alt="logo-karnas">
                </div>
            </div>
            <div class="col-md-12">
                <div>
    ...
    <li class="nav-item active">
        ...
        <?php if ($user['role_id'] == 17) : ?>
			<a class="nav-link" download="panduan_operator.pdf" href="<?= base_url('tutorial/panduan_operator.pdf') ?>">
        <?php elseif ($user['role_id'] == 3) : ?>
            <a class="nav-link" download="panduan_guru.pdf" href="<?= base_url('tutorial/panduan_guru.pdf') ?>">
        <?php elseif ($user['role_id'] == 6) : ?>
			<a class="nav-link" download="panduan_siswa.pdf" href="<?= base_url('tutorial/panduan_siswa.pdf') ?>">
		<?php elseif ($user['role_id'] == 29 or $user['role_id'] == 30 or $user['role_id'] == 4 or $user['role_id'] == 5) : ?>
			<a class="nav-link" download="panduan_pimpinan.pdf" href="<?= base_url('tutorial/panduan_pimpinan.pdf') ?>">
		<?php elseif ($user['role_id'] == 28) : ?>
			<a class="nav-link" download="panduan_bk.pdf" href="<?= base_url('tutorial/panduan_bk.pdf') ?>">
		<?php else : ?>
            <a class="nav-link" download="panduan_admin.pdf" href="<?= base_url('tutorial/panduan_admin.pdf') ?>">
        <?php endif; ?>
        	<i class="fa fa-download" aria-hidden="true"></i>
        <span>Download Tutorial</span></a>
    </li>
    <hr class="sidebar-divider mt-2">
