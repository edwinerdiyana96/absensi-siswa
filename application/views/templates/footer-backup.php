...
if ($user['role_id'] == '6') {
    ...
    elseif($cek_ruangan == 0) { ?>
        ...
        <form id='form_maps2' action="<?= base_url('scan/km') ?>" method="post">

            <input hidden type='text' name="lat" id='lat2' value=''>

            <input hidden type='text' name="long" id='long2' value=''>
        ...
        <script type="text/javascript">
            ...
            function getLatLon(position) {
                ...
                $(document).ready(function() {
                    $('#kirim1').click(function() {
                        var txtLat = document.getElementById("lat2").innerHTML = latitude;
                        var txtLong = document.getElementById("long2").innerHTML = longitude;
                        $('#lat2').val(txtLat);
                        $('#long2').val(txtLong);
                        
                        document.getElementById("form_maps2").submit();
