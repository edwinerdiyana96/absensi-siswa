	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<div class="responsive">
				<table class="table table-striped table-bordered text-nowrap" id="table-kelas" style="width:100%;">
			...
			<form action="<?= base_url('operator/kelas/add') ?>" method="POST">
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="group_id" name="group_id" placeholder="Kode Group">
					</div>
					<!-- <div class="form-group">
